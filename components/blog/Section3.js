...
const Section3 = () => {
    ...
    const uniq = [...new Set(data)].filter(item => item.category === 'Periapicais').slice(0, 4);
    const digituniq = [...new Set(data)].filter(item => item.category === 'Digitalizadores').slice(0, 4);
                ...
                <div className="col-sm-12 col-md-8">
                    ...
                    <div className="row">
                        <div className="col-md-8 mt-1">
                            <div class="card">
                                {loading ? <div>Loading...</div> : <img class="card-img-top" src={uniq[0].photo} alt="Card image cap" />}
                                ...
                                <div class="card-body">
                                    {loading ? <div>Loading...</div> : <p class="card-text font-news">{uniq[0].body}<span className="heading-business-news">readmore</span></p>}
                                    <div>
                        ...
                        <div className="col-md-4">
                            {loading ? <div>Loading...</div> : <div className="business-news" style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                <p ><span className="business-news-heading">{uniq[1].title}</span><br />{uniq[1].body}</p>
                            </div>}
                            {loading ? <div>Loading...</div> : <div className="business-news" style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                <p><span className="business-news-heading">{uniq[2].title}</span><br />{uniq[2].body}</p>
                            </div>}
                            {loading ? <div>Loading...</div> : <div className="business-news" style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                <p><span className="business-news-heading">{uniq[2].title}</span><br />{uniq[2].body}</p>
                            </div>}
                                    ...
                                    <div>
                                        <div class="card">
                                            ...
                                            <div class="card-img-overlay mt-5 text-white">
                                                ...
                                                <p class="card-text">{item.body}<br /><span>by Tiem Neguyn</span></p>
                                            </div>
                                        </div>
                                    </div>
                                )
