...
const Section2 = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8000/getblog`)
            .then(res => {
                const { data } = res
                SetData(data)
                setLoading(false)
    ...
    const uniq = [...new Set(data)].filter(item => item.category === 'Panorâmicos').slice(0,4);
    return (
                ...
                <div className="col-sm-12 col-md-8">
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-8 mt-1">
                            <div class="card">
                            {loading ? <div>Loading....</div> : <img  class="card-img-top" src={uniq[0].photo} />}
                                <div class="card-img-overlay mt-5 text-white">
                                    {loading ? <div>title</div> : <h5 class="card-title bg-orange mt-5">{uniq[0].title}</h5>}
                                ...
                                <div class="card-body bg-orangered text-white">
                                    {loading ? <div>...</div> : <p class="card-text font-news">{uniq[0].body} <span className="heading-business-news text-white">readmore</span></p>}
                                    <div>
                        ...
                        <div className="col-sm-12 col-md-4">
                            <div class="card mb-3">
                                {loading ? <div>image</div> : <img class="card-img-top" src={uniq[1].photo} alt="Card image cap" />}
                                {loading ? <div>loading...</div> : <div class="card-img-overlay">
                                    <h5 class="card-title bg-color-img-overlay stuff-pick-img-overlay-font">{uniq[1].title}</h5>
                                    <p class="card-text stuff-pick-img-overlay-font">{uniq[1].body}<br /><span>by Tiem Neguyn</span></p>
                                </div>}
                            </div>
                            <div class="card mb-3">
                                {loading ? <div>image</div> : <img class="card-img-top" src={uniq[2].photo} alt="Card image cap" />}
                                {loading ? <div>loading...</div> : <div class="card-img-overlay">
                                    <h5 class="card-title bg-color-img-overlay stuff-pick-img-overlay-font">{uniq[2].title}</h5>
                                    <p class="card-text stuff-pick-img-overlay-font">{uniq[2].body}<br /><span>by Tiem Neguyn</span></p>
                                </div>}
                            </div>
                            <div class="card">
                                {loading ? <div>image</div> : <img class="card-img-top" src={uniq[3].photo} alt="Card image cap" />}
                                {loading ? <div>loading...</div> : <div class="card-img-overlay">
                                    <h5 class="card-title bg-color-img-overlay stuff-pick-img-overlay-font">{uniq[3].title}</h5>
                                    <p class="card-text stuff-pick-img-overlay-font">{uniq[3].body}<br /><span>by Tiem Neguyn</span></p>
                                </div>}
                            </div>
                        </div>
                    </div>
