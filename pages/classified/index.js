        ...
        {data.map((item) => {
          return (
            <div key={item._id}>
              ...
              >
                <a>
                  <div style={{ padding: "0 5px 0 5px", maxWidth: "170px", margin: "15px 0px", position: "relative", margin: "0px 10px", border: "1px solid rgba(0, 0, 0, 0.1)" }}>
                    <img style={{minWidth:"160px", maxWidth:"160px", minHeight:"180px", maxHeight:"180px"}} src={item.productImage[0]} />
                    <p style={{marginLeft: "5px", marginBottom: "3px", marginTop:"5px", color: "Grey", fontWeight: "bold"}}> {item.model}</p>
                    <p style={{marginLeft: "5px", marginBottom: "3px"}}> {item.year}</p>
                    <p style={{marginLeft: "5px", marginBottom: "3px"}}> {item.category}</p>
                    <p style={{marginLeft: "5px", marginBottom: "3px"}}> {item.description}</p>
                    <p style={{marginLeft: "5px", marginBottom: "3px"}}> {item.location}</p>
                    <p style={{marginLeft: "5px", marginBottom: "3px"}}> R$ {item.price}</p>
